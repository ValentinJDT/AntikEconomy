package fr.mrcoq.antikeconomy;

import fr.mrcoq.antikeconomy.economy.EconomyImplementer;
import fr.mrcoq.antikeconomy.economy.Salarie;
import fr.mrcoq.antikeconomy.economy.VaultHook;
import fr.mrcoq.antikeconomy.sql.BalancesInterface;
...
public final class AntikEconomy extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if(getConfig().getBoolean("salarie.enable")) {
            Salarie.autoSend();
        }
    }
